...
import { Flag, RefreshCcw } from "lucide-react"; // Import Flag and Refresh icon
    ...
    return (
        ...
        >
            ...
            <div className="absolute bottom-4 right-3 flex gap-2">
                <button
                    onClick={play}
                    className="flex items-center bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded transition duration-300 transform hover:scale-105 shadow-md"
                >
                ...
                <button
                    onClick={handleReset}
                    className="flex items-center bg-red-700 hover:bg-red-600 text-white font-bold py-2 px-4 rounded transition duration-300 transform hover:scale-105 shadow-md"
                >
