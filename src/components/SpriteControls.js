...
const SpriteControls = () => {
  ...
  return (
    <div className="flex flex-col border-t-2 border-gray-200 bg-gray-100 p-4 shadow-lg" style={{ flex: 0.2 }}>
      <div className="flex justify-between items-center mb-4">
        <h2 className="font-bold text-xl text-gray-800">Sprites</h2>
